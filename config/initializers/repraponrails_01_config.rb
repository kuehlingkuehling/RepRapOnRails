RepRapOnRails::Application.configure do
  ...
  when "vp75-op-1.0.0"
    ...
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.0.0-06"
  ...
  when "vp75-1.1.0"
    ...
    # compatible Arduino Firmware version
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.1.0-04"
  ...
  when "vp75-1.1.1"
    ...
    # hardware revision
    config.hardware_revision = "1.1.1"
    ...
    # compatible Arduino Firmware version
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.1.1-03"
  ...
  when "vp75-1.1.2"
    ...
    # compatible Arduino Firmware version
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.1.2-02"
  ...
  when "vp75-1.2.0"
    ...
    # hardware revision
    config.hardware_revision = "1.2.0"
    ...
    # compatible Arduino Firmware version
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.2.0-02"
  ...
  when "vp75-1.2.1"
    ...
    # hardware revision
    config.hardware_revision = "1.2.1"
    ...
    # compatible Arduino Firmware version
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.2.1-01"
  ...
  when "vp75-1.2.2"
    ...
    # hardware revision
    config.hardware_revision = "1.2.2"
    ...
    # compatible Arduino Firmware version
    config.arduino_firmware_version = "Repetier Firmware v0.92-vp75-1.2.2-01"
